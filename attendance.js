...
;(function() {	
	...
	function saveCSVFile(){
		...
		chrome.storage.sync.get( null, function(r) {
			...
			let footer= '\n\n"Help/more info:", "https://www.facebook.com/GoogleMeetAttendance/posts/209211534096819"\nThis file was generated by the Meet Course Analyzer extension: https://chrome.google.com/webstore/detail/fkdjflnaggakjamjkmimcofefhppfljd/publish-accepted?authuser=0&hl=en'
	...
	function createAttendanceFields(){
		...
		gv.innerText = 'meet Course Analyzer - v'+chrome.runtime.getManifest().version
