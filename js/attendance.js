...
;(function() {	
	...
	function saveCSVFile(){
		...
		chrome.storage.sync.get( null, function(r) {
			...
			let footer= '\n\n"Help/more info:", "https://www.facebook.com/GoogleMeetAttendance/posts/209211534096819"\nThis file was generated by the  extension: https://chrome.google.com/webstore/detail/fkdjflnaggakjamjkmimcofefhppfljd/publish-accepted?authuser=0&hl=en'
	...
	function createAttendanceFields(){
		...
		cnf.setAttribute( 'placeholder', 'Entrez les notes spécifiques à cette classe.' )
		il.setAttribute( 'placeholder', 'Votre liste de cours se trouve ici. \nCliquez sur le point d interrogation bleu ci-dessous pour obtenir de l aide.' )
		...
		gv.innerText = ' - v'+chrome.runtime.getManifest().version
